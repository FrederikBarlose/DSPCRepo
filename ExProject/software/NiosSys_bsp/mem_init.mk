...
$(MEM_0)_HIERARCHICAL_PATH := fpga_sdram
$(MEM_0)_WIDTH := 16
...
.PHONY: fpga_sdram
fpga_sdram: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory2_1
MEM_1 := CPU_System_onchip_memory2_1
