...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../CPU_System.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4011060
SOPC_SYSID_FLAG += --sidp=0x4011060
ELF_PATCH_FLAG  += --sidp 0x4011060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1557305356
SOPC_SYSID_FLAG += --timestamp=1557305356
ELF_PATCH_FLAG  += --timestamp 1557305356
